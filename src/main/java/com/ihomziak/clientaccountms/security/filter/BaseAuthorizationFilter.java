...
public abstract class BaseAuthorizationFilter extends BasicAuthenticationFilter {

	protected final Environment environment;

	protected BaseAuthorizationFilter(AuthenticationManager authManager, Environment environment) {
		super(authManager);
